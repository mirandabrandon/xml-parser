...
public class Bsik {
    ...
    private LocalDate hBudat; // Data de lançamento no documento
    private LocalDate hBldat; // Data no documento
    private LocalDate cpudt; // Data da entrada do documento contábil
    private String hWaers;    // Código da moeda
    private String xblnr;    // Nº documento de referência
    private String hBlart;   // Tipo de documento
    ...
    private LocalDate undefinedDateField; // TODO: get field info
    ...
    private String xnegp;    // Código: lançamento negativo
    ...
    private String gmvkz;    // Partida em execução
    // TODO: fix fields below
    private String undefinedFieldWith4Chars; // Campo não identificado com tamanho = 4
